                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                            ...
                            <div class="listview listview--hover">
                                <a href="#" class="listview__item">
                                    <img src="{{asset('demo/img/profile-pics/1.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('demo/img/profile-pics/2.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('demo/img/profile-pics/3.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('demo/img/profile-pics/4.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('demo/img/profile-pics/5.jpg')}}" class="avatar-img" alt="">
