...
<div class="card">
        <div class="card-body">
            ...
            <form class="row aboits'" action="{{url('update_abouts')}}" method="post"  enctype="multipart/form-data">
            @else
            <h4 class="card-title">Add About</h4>
            <hr>
            <form class="row aboits'" action="{{url('create_abouts')}}" method="post"  enctype="multipart/form-data">
            @endif 
            @csrf
                <input type="hidden" name="aboutid" value="{{$id}}">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        @else
                        <button type="submit" class="btn btn-theme">Add Abouts</button>
                        @endif
                    </div>
            </form>
