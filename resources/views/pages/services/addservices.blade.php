...
<div class="card">
        <div class="card-body">
            @if(!empty($id))
            <h4 class="card-title">Update Service</h4><hr>
            <form class="row services'" action="{{url('update_services')}}" method="post"  enctype="multipart/form-data">
            @else
            <h4 class="card-title">Add Service</h4>
            <hr>
            <form class="row services'" action="{{url('create_services')}}" method="post"  enctype="multipart/form-data">
            @endif 
            @csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <br>
                        @if(!empty($id))
                        <button type="submit" class="btn btn-theme">Update services</button>
                        @else
                        <button type="submit" class="btn btn-theme">Add services</button>
                        @endif
                    </div>
            </form>
