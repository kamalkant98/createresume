...
<div class="container" style="height: auto; ">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-12 col-md-8 col-sm-8 ml-auto mr-auto" style="margin-top:90px;">
        ...
        <div class="card card-login card-hidden mb-3" style="background-color:#0000004a;">
          <div class="card-header card-header-primary text-center">
            ...
            <div class="social-line">
              <a href="#pablo" class="btn btn-just-icon btn-link btn-black">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
              </svg>
              </a>
              <a href="#pablo" class="btn btn-just-icon btn-link btn-back">
          ...
          <div class="card-body ">
			...
			<div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }} col-md-6">
              <div class="input-group">
                ...
                <input type="text" name="telephone"  class="form-control input-mask" data-mask="+910000000000" placeholder="+910000000000" value="{{ old('telephone') }}">
            ...
            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} col-md-6">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">
					R-Password
            ...
            <div class="form-check ml-3 col-md-4">
